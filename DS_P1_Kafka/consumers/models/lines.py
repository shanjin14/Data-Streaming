...
class Lines:
    ...
    def process_message(self, message):
        ...
        if "com.cta.stations.arrival" in message.topic() or 'com.cta.database.stations_transformed' in message.topic() :
            value = message.value()
            if message.topic() == "com.cta.database.stations_transformed":
